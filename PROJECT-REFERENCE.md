...
| Frontend Page      | UI Features                                                                                                                                                                                                              | Backend APIs Called                                                                                                                                                                                                                                         | Backend Service/Controller                                                                                                                                                                                                                                                                                                                                                                                               | Database Models         |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| `/` (Home)         | Landing page, hero section, feature cards, destination grid                                                                                                                                                              | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/chat`            | AI trip planner, chat messages, trip state machine, generative UI chips, date picker, itinerary card with flight/hotel modifier, cost tracker, globe map                                                                 | `POST /api/chat` (send message), `POST /api/trips/generate` (generate itinerary), `DELETE /api/chat` (clear conversation), `PUT /api/trips/:id` (persist changes), `GET /api/external/flights` (search flights), `GET /api/external/hotels` (search hotels) | `chatController.sendMessage`, `chatController.generateItinerary`, `chatController.clearChat`, `tripController.update`, `externalController.flights`, `externalController.hotels` → `services/ai/agent.js` (generateItinerary, chat), `services/memory/memoryService.js`, `services/graph/graphService.js`, `services/vector/vectorService.js`, `services/external/flightService.js`, `services/external/hotelService.js` | Trip, User, UserMemory  |
| `/planner`         | Trip planner input, popular destination chips, quick actions                                                                                                                                                             | None (redirects to `/chat?q=...` or `/chat?destination=...`)                                                                                                                                                                                                | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/dashboard`       | Live stats (location, time, weather, currency), weather alerts, 7-day forecast, nearby places (9 categories), food search, attractions, UNESCO sites, currency exchange, emergency contacts, recent trips, quick actions | `GET /api/external/detect-location`, `GET /api/external/nearby-all`, `GET /api/external/weather`, `GET /api/external/forecast`, `GET /api/external/attractions`, `GET /api/external/unesco`, `GET /api/external/places` (food search), `GET /api/trips`     | `externalController.*`, `tripController.getAll` → `services/external/weatherService.js`, `services/external/mapsService.js`, Overpass API, UNESCO DataHub API, `open.er-api.com` (currency)                                                                                                                                                                                                                              | Trip                    |
| `/destinations`    | City search, hero banner, weather stats, restaurants (halal-first), attractions, UNESCO sites, plan trip CTA                                                                                                             | `GET /api/external/geocode`, `GET /api/external/weather`, `GET /api/external/attractions`, `GET /api/external/places`, `GET /api/external/unesco`                                                                                                           | `externalController.geocodePlace`, `externalController.weather`, `externalController.attractions`, `externalController.places`, `externalController.unesco` → `services/external/mapsService.js`, `services/external/weatherService.js`                                                                                                                                                                                  | None                    |
| `/trips`           | List all user trips, status badges, view details                                                                                                                                                                         | `GET /api/trips`                                                                                                                                                                                                                                            | `tripController.getAll`                                                                                                                                                                                                                                                                                                                                                                                                  | Trip                    |
| `/trips/[id]`      | Trip detail view, itinerary days, flight/hotel info                                                                                                                                                                      | `GET /api/trips/:id`                                                                                                                                                                                                                                        | `tripController.getById`                                                                                                                                                                                                                                                                                                                                                                                                 | Trip                    |
| `/community`       | Browse public trips, search, sort, like, clone, join, comments                                                                                                                                                           | `GET /api/community/trips`, `POST /api/community/trips/:id/like`, `POST /api/community/trips/:id/clone`, `POST /api/community/trips/:id/comment`, `DELETE /api/community/trips/:id/comment/:commentId`, `POST /api/groups`                                  | `communityController.*`, `groupController.create`                                                                                                                                                                                                                                                                                                                                                                        | Trip, User, Group       |
| `/community/[id]`  | Single public trip detail                                                                                                                                                                                                | `GET /api/community/trips/:id`                                                                                                                                                                                                                              | `communityController.getPublicTrip`                                                                                                                                                                                                                                                                                                                                                                                      | Trip                    |
| `/profile`         | User profile display, avatar, bio, travel stats                                                                                                                                                                          | `GET /api/users/profile`                                                                                                                                                                                                                                    | `userController.getProfile`                                                                                                                                                                                                                                                                                                                                                                                              | User                    |
| `/settings`        | Personal info (name, age, gender), travel preferences (destinations, accommodation, activities, budget), change password, delete account                                                                                 | `GET /api/users/profile`, `PUT /api/users/profile`, `PUT /api/users/preferences`, `PUT /api/users/change-password`, `DELETE /api/users/profile`                                                                                                             | `userController.*`                                                                                                                                                                                                                                                                                                                                                                                                       | User, Trip (for delete) |
| `/admin`           | Admin dashboard stats, user management, trip management                                                                                                                                                                  | `GET /api/admin/stats`, `GET /api/admin/users`, `PUT /api/admin/users/:id`, `DELETE /api/admin/users/:id`, `GET /api/admin/trips`                                                                                                                           | `adminController.*`                                                                                                                                                                                                                                                                                                                                                                                                      | User, Trip, Group       |
| `/auth/callback`   | Google OAuth callback handler                                                                                                                                                                                            | `GET /api/auth/google/callback`                                                                                                                                                                                                                             | Passport.js Google Strategy                                                                                                                                                                                                                                                                                                                                                                                              | User                    |
| `/login`           | Login form                                                                                                                                                                                                               | `POST /api/auth/login`                                                                                                                                                                                                                                      | `authController.login`                                                                                                                                                                                                                                                                                                                                                                                                   | User                    |
| `/signup`          | Registration form                                                                                                                                                                                                        | `POST /api/auth/register`, `POST /api/auth/verify`                                                                                                                                                                                                          | `authController.register`, `authController.verifyOTP` → `services/emailService.js` (Brevo)                                                                                                                                                                                                                                                                                                                               | User                    |
| `/forgot-password` | Forgot password form                                                                                                                                                                                                     | `POST /api/auth/forgot-password`                                                                                                                                                                                                                            | `authController.forgotPassword` → `services/emailService.js`                                                                                                                                                                                                                                                                                                                                                             | User                    |
| `/reset-password`  | Reset password form                                                                                                                                                                                                      | `POST /api/auth/reset-password`                                                                                                                                                                                                                             | `authController.resetPassword`                                                                                                                                                                                                                                                                                                                                                                                           | User                    |
| `/about`           | About page                                                                                                                                                                                                               | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/blog`            | Blog page                                                                                                                                                                                                                | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/careers`         | Careers page                                                                                                                                                                                                             | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/guides`          | Travel guides                                                                                                                                                                                                            | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/help`            | Help center                                                                                                                                                                                                              | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/api-docs`        | API documentation                                                                                                                                                                                                        | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/privacy`         | Privacy policy                                                                                                                                                                                                           | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/terms`           | Terms of service                                                                                                                                                                                                         | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |
| `/cookies`         | Cookie policy                                                                                                                                                                                                            | None (static)                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                                                                                                                                                                                     | None                    |

### Global Components → Backend APIs

| Component        | Location                              | Backend APIs                                                                                      | Purpose                                                                     |
| ---------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| Navigation       | `components/layout/Navigation.jsx`    | None (uses hooks)                                                                                 | Navbar with location, weather, notifications, user dropdown, admin link     |
| useLocation hook | `hooks/useLocation.js`                | `GET /api/external/detect-location`, `GET /api/external/reverse-geocode`, Browser Geolocation API | GPS + IP dual location detection                                            |
| useWeather hook  | `hooks/useWeather.js`                 | OpenWeatherMap API, wttr.in API                                                                   | Weather data for navbar + dashboard                                         |
| CookieConsent    | `components/ui/CookieConsent.jsx`     | None (localStorage only)                                                                          | GDPR cookie consent banner                                                  |
| ItineraryCard    | `components/chat/ItineraryCard.jsx`   | `GET /api/external/flights`, `GET /api/external/hotels`, `PUT /api/trips/:id`                     | Trip itinerary display with flight/hotel modifier                           |
| QuickReplyChips  | `components/chat/QuickReplyChips.jsx` | None (UI only)                                                                                    | Chat chips for destination, duration, companion, vibe, budget + date picker |

### Backend Services Pipeline (Trip Generation)

When user generates a trip, this pipeline runs in `backend/services/ai/agent.js`:

1. `preferenceEngine.getPreferences()` → merge user prefs with request
2. `preferenceEngine.getCachedAIResponse()` → check Redis cache
3. `graphService.graphRAGSearch()` → query Neo4j knowledge graph
4. `graphService.getPersonalizedRecommendations()` → Neo4j personalized recs
5. `memoryService.getLongTermMemory()` → MongoDB user memory
6. `vectorService.semanticSearch()` → Pinecone vector search
7. `mapsService.geocode()` → Nominatim geocoding
8. `weatherService.getCurrentWeather()` → OpenWeatherMap
9. `currencyService.getExchangeRate()` → Exchange rate API
10. `flightService.searchFlights()` → RapidAPI Sky Scanner
11. `hotelService.searchHotels()` → RapidAPI Booking.com
12. `memoryService.getConversation()` → Redis chat history
13. OpenAI GPT-4o-mini → generate itinerary JSON
14. `preferenceEngine.cacheAIResponse()` → cache in Redis
15. `memoryService.addMessage()` → save to Redis
16. `memoryService.trackInteraction()` → Redis + MongoDB
17. `memoryService.saveTripToMemory()` → MongoDB
18. `Trip.create()` → save trip to MongoDB

### Utility Functions

| File                                 | Functions                                                         | Used By                             |
| ------------------------------------ | ----------------------------------------------------------------- | ----------------------------------- |
| `lib/crowdLevel.js`                  | `getCrowdInfo(placeType, hour, dayOfWeek)`                        | Dashboard attractions, destinations |
| `components/chat/itinerary-utils.js` | `parsePriceRaw()`, `recalculateDates()`, `calculateCosts()`       | ItineraryCard flight/hotel modifier |
| `hooks/useTripState.js`              | `extractFields()`, `getNextQuestionFromState()`, `useTripState()` | Chat page trip state machine        |
| `hooks/useCurrency.js`               | `useCurrency(from, to)`                                           | Currency conversion                 |
| `hooks/useMediaQuery.js`             | `useMediaQuery()`                                                 | Responsive breakpoints              |
| `hooks/useScrollPosition.js`         | `useScrollPosition()`                                             | Scroll-based UI                     |
| `hooks/useAuthGuard.js`              | `useAuthGuard()`                                                  | Protected page redirects            |

### Zustand Stores

| Store            | File                        | State                         | Used By                 |
| ---------------- | --------------------------- | ----------------------------- | ----------------------- |
| authStore        | `store/authStore.js`        | user, token, isAuthenticated  | All authenticated pages |
| tripStore        | `store/tripStore.js`        | trips[], currentTrip, loading | Trips page              |
| preferenceStore  | `store/preferenceStore.js`  | destinationCurrency, tempUnit | Destinations, navbar    |
| destinationStore | `store/destinationStore.js` | city, country, currency       | Destinations page       |
