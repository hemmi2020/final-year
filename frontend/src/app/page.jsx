    ...
    <div style={{ background: "#FFFFFF" }}>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 80 }}>
          <p className="section-label">✈️ How It Works</p>
          <h2
            style={{
        ...
        {[
          ...
          },
          {
            step: "04",
            title: "Travel & Enjoy",
            desc: "Save your plan, share with your group, track locations in real-time. Your AI assistant is always with you.",
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            ...
            <p style={{ fontSize: 17, color: "#6B7280", marginTop: 12 }}>
              Discover destinations curated by our AI
            </p>
          </div>
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Indoor activities on rainy days, outdoor on sunny. Your itinerary adapts to weather.",
          ...
          <div style={{ flex: 1, minWidth: 300 }}>
            ...
            >
              ...
              >
                ...
                >
                  3-day Istanbul trip, halal food, family
                </p>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  ...
                  (halal) → Blue Mosque. Day 2: Grand Bazaar → Hafiz Mustafa...
                </p>
              </div>
            </div>
          </div>
            ...
            {[
              {
                ...
                text: "TravelAI planned our Istanbul trip with halal restaurants near every attraction. The AI knew exactly what we needed!",
                avatar:
              ...
              },
              {
                name: "Sarah Chen",
                role: "Solo Explorer",
                text: "The AI remembered my preferences from last time and suggested even better options. It actually learns!",
                avatar:
              ...
              },
              {
                ...
                text: "Weather-aware itinerary was genius — moved outdoor activities to sunny days and suggested museums for rainy ones.",
                avatar:
