            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <button
                  ...
                  className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors duration-150 font-medium"
                >
                  Get Started
                </button>
              </>
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="block w-full px-3 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors duration-150 font-medium text-center"
                  >
                    Get Started
                  </button>
                </>
