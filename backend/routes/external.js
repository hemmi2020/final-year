...
const { weather, forecast, places, currency, geocodePlace, attractions, reverseGeocode, flights, hotels, bookingAttractions, detectLocation, nearby } = require('../controllers/externalController');
